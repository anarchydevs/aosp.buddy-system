...
namespace WarpDB2
{
    public static class SettingsController
    {
        ...
        private static void RegisterChatCommandIfNotRegistered()
        {
            ...
            {
                Chat.RegisterCommand("db2", (string command, string[] param, ChatWindow chatWindow) =>
                {
                    try
                    {
                        ...
                        settingsWindow = Window.Create(new Rect(50, 50, 300, 300), "WarpDB2", "Settings", WindowStyle.Default, WindowFlags.AutoScale);
