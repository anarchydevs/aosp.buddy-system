...
namespace VortexxBuddy
{
    public static class Constants
    {
        ...
        //outside
        public static Vector3 _entrance = new Vector3(523.6f, 310.9f, 307.4f); 
        public static Vector3 _reneterPos = new Vector3(519.9f, 310.9f, 312.4f); 
       ...
       // public static Vector3 _returnPosition = new Vector3(397.7f, 28.2f, 353.3f);
        ...
        //Podiums
        public static Vector3 _redPodium = new Vector3(175.0f, 17.6f, 201.1f); 
        public static Vector3 _greenPodium = new Vector3(363.8f, 29.7f, 395.3f); //need
        public static Vector3 _yellowPodium = new Vector3(233.0f, 16.7f, 202.0f); 
        public static Vector3 _bluePodium = new Vector3(205.0f, 17.5f, 179.2f); 
