...
namespace AXPBuddy
{
    public static class Constants
    {
        ...
        public static Vector3 UnicornLever = new Vector3(71.0f, 101.0f, 232.0f);
        public static Vector3 Bridge = new Vector3(140.4, 101.0, 216.0);
        public static Vector3 BridgeTurn = new Vector3(139.2, 100.9, 282.2);

        public static Vector3 MarkerpPoll = new Vector3(198.3, 0.3, 242.5);
