...
namespace DB2Buddy
{
    ...
    public static class SettingsController
    {
        ...
        private static void RegisterChatCommandIfNotRegistered()
        {
            ...
            {
                Chat.RegisterCommand("DB2Buddy", (string command, string[] param, ChatWindow chatWindow) =>
                {
                    try
                    {
                        ...
                        settingsWindow = Window.Create(new Rect(50, 50, 300, 300), "DB2Buddy", "Settings", WindowStyle.Default, WindowFlags.AutoScale);
                        ...
                        foreach (string settingsName in settingsWindows.Keys)
                        {
                            ...
                            settingsWindow.FindView("WarpRangeBox", out TextInputView WarpRangeInput);
                            ...
                            if (WarpRangeInput != null)
                                WarpRangeInput.Text = $"{Config.CharSettings[Game.ClientInst].WarpRange}";
                        }
                    }
                    catch (Exception e)
                    {
