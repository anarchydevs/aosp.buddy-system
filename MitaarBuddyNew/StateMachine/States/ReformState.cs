...
namespace MitaarBuddy
{
    public class ReformState : IState
    {
        ...
        public void OnStateEnter()
        {
            ...
            MitaarBuddy._passedFirstCorrectionPos = false;
            MitaarBuddy._passedSecondCorrectionPos = false;

            if (MitaarBuddy._settings["Merge"].AsBool() || DynelManager.LocalPlayer.Identity != MitaarBuddy.Leader)
            {
