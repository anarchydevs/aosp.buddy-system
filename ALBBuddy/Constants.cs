...
namespace ALBBuddy
{
    public static class Constants
    {
        ...
        public static Vector3 PosOne = new Vector3(415.0f, 32.8f, 301.0f); //415.8, 301.0, 32.8
        ...
        public static Vector3 EndPos = new Vector3(329.2f, 36.0f, 98.8f); //329.2, 98.8, 36.0    415.8, 32.8, 301

        public const int Inferno = 4005;
        public const int Albtraum = 4337;

        public const float MaxPullDistance = 40;
