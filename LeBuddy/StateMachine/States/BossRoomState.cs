    ...
    public class BossRoomState : IState
    {
        ...
        private void HandleBiologicalMetamorphosesVoid()
        {
            ...
            if (_attackMobs != null)
            {
                ...
                {
                    LeBuddy.NavMeshMovementController.SetNavMeshDestination(_attackMobs.Position);
                }
                else
                {
            ...
            else if (_regenerationConduit != null)
            {
                ...
                {
                    LeBuddy.NavMeshMovementController.SetNavMeshDestination(_regenerationConduit.Position);
                }
                else
                {
                    if (DynelManager.LocalPlayer.FightingTarget == null
            ...
            else
            {
                ...
                {
                    LeBuddy.NavMeshMovementController.SetNavMeshDestination(_masterofBiologicalMetamorphoses.Position);
                }
                else
                {
                    if (DynelManager.LocalPlayer.FightingTarget == null
        ...
        private void HandlePsyModVoid()
        {
            ...
            else
            {
                ...
                {
                    LeBuddy.NavMeshMovementController.SetNavMeshDestination(_masterofPsyMod.Position);
                }
                else
                {
                    if (DynelManager.LocalPlayer.FightingTarget == null
        ...
        private void HandleSilenceVoid()
        {
            ...
            else if (_attackMobs == null)
            {
                ...
                {
                    LeBuddy.NavMeshMovementController.SetNavMeshDestination(_masterofSilence.Position);
                }
                else
                {
                    if (DynelManager.LocalPlayer.FightingTarget == null
        ...
        private void HandleOtherVoid()
        {
            if (_coccoonAttendant != null || _alienCoccoon != null || _chaHeru != null)
            {
                ...
                else if (_attackMobs == null)
                {
                    ...
                    {
                        LeBuddy.NavMeshMovementController.SetNavMeshDestination(_coccoonAttendant.Position);
                    }
                    else
                    {
                        if (DynelManager.LocalPlayer.FightingTarget == null
                ...
                else if (_alienCoccoon != null && _attackMobs == null)
                {
                    ...
                    {
                        LeBuddy.NavMeshMovementController.SetNavMeshDestination(_alienCoccoon.Position);
                    }
                    else
                    {
                        if (DynelManager.LocalPlayer.FightingTarget == null
