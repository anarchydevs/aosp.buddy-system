...
namespace InfBuddy
{
    public static class Constants
    {
        ...
        public static Vector3 DefendPos = new Vector3(166.0f, 2.2f, 186.7f); // 166.0, 186.7, 2.2
        public static Vector3 RoamPos = new Vector3(185.4f, 1.0f, 189.5f); //184.5f, 1.0f, 242.9f
